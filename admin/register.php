...
<head>
    <meta charset="utf-8">
    <title>Bryan Balaga | Register</title>
	        ...
	        <div class="row h-100">
	            <div class="col-12">
	                <div class="text-center m-0 vh-75 d-flex flex-column justify-content-center text-light">
	                    ...
	                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>" id="register-form">
	                    <div class="row">
	                    ...
	                    <div class="mt-1 mx-auto">
	                    	<input type="submit" class="btn btn-outline-light" id="register" name="register" value="Join"/>
                        </div>
                    	</form>
                    	<div class="row">
                            <div class="col-lg-4 col-sm-6 mx-auto text-left">
                                ...
                                <a class="text-primary" href="./index.php">Login.</a>
                            </div>
                        </div>
	                </div>
	            </div>
